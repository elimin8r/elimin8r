...
gulp.task('images', function() {
  return gulp.src([srcDir +'/images/**/*.+(png|jpg|svg|gif)', "!" + srcDir + "/images/no-compression/*.+(png|jpg|svg|gif)"])
  .pipe(cache(imagemin()))
  .pipe(gulp.dest(destDir +'/images'));
});

// Move uncompressed images across
gulp.task('copyUncompressedImages', function(){
  return gulp.src(srcDir + "/images/no-compression/*.+(png|jpg|svg|gif)")
  .pipe(gulp.dest(destDir +'/images'));
});
...
gulp.task('build', function(callback) {
  runSequence('clean:dist', ['sass', 'terser', 'images', 'copyUncompressedImages'], 'minify-css', 'cachebust', callback);
});