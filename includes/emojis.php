...
function add_disable_emojis_checkbox() {
    add_settings_field( 'disable_emojis_checkbox', 'Disable emojis', 'disable_emojis_checkbox_callback', 'reading', 'default' );
    register_setting( 'reading', 'disable_emojis_checkbox' );
}

// Disable Emojis checkbox callback
function disable_emojis_checkbox_callback() {
...
add_action( 'admin_init', 'add_disable_emojis_checkbox' );
