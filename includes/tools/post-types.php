...
function elimin8r_handle_post_type_registration() {
    ...
    foreach ( $post_types as $post_type ) {
        if ( isset( $post_type['plural_label'] ) && isset( $post_type['singular_label'] ) && isset( $post_type['post_type_slug'] ) ) {
            ...
            $labels = array(
                'name' => _x( '%s', 'Post type general name', 'elimin8r' ),
                'singular_name' => _x( '%s', 'Post type singular name', 'elimin8r' ),
                'menu_name' => _x( '%s', 'Admin Menu text', 'elimin8r' ),
                'name_admin_bar' => _x( '%s', 'Add New on Toolbar', 'elimin8r' ),
                'add_new' => __( 'Add New', 'elimin8r' ),
                'add_new_item' => __( 'Add New %s', 'elimin8r' ),
                'new_item' => __( 'New %s', 'elimin8r' ),
                'edit_item' => __( 'Edit %s', 'elimin8r' ),
                'view_item' => __( 'View %s', 'elimin8r' ),
                'all_items' => __( 'All %s', 'elimin8r' ),
                'search_items' => __( 'Search %s', 'elimin8r' ),
                'parent_item_colon' => __( 'Parent %s: ', 'elimin8r' ),
                'not_found' => __( 'No %s found.', 'elimin8r' ),
                'not_found_in_trash' => __( 'No %s found in Trash.', 'elimin8r' ),
            );
            $args = array(
                'label' => $plural,
                'labels' => $labels,
